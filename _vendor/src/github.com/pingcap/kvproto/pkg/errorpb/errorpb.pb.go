...
type StaleEpoch struct {
	OBSOLETENewRegions []*metapb.Region `protobuf:"bytes,1,rep,name=OBSOLETE_new_regions,json=OBSOLETENewRegions" json:"OBSOLETE_new_regions,omitempty"`
	XXX_unrecognized   []byte           `json:"-"`
}
...
func (m *StaleEpoch) GetOBSOLETENewRegions() []*metapb.Region {
	if m != nil {
		return m.OBSOLETENewRegions
	}
	return nil
}
...
func (m *StaleEpoch) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.OBSOLETENewRegions) > 0 {
		for _, msg := range m.OBSOLETENewRegions {
			dAtA[i] = 0xa
			i++
...
func (m *StaleEpoch) Size() (n int) {
	...
	_ = l
	if len(m.OBSOLETENewRegions) > 0 {
		for _, e := range m.OBSOLETENewRegions {
			l = e.Size()
			n += 1 + l + sovErrorpb(uint64(l))
		}
	}
...
func (m *StaleEpoch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OBSOLETENewRegions", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OBSOLETENewRegions = append(m.OBSOLETENewRegions, &metapb.Region{})
			if err := m.OBSOLETENewRegions[len(m.OBSOLETENewRegions)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorErrorpb = []byte{
	...
	,
}
